...
python train_test_generalized_surface_normal.py   --rectified_checkpoint_path '/mars/mnt/oitstorage/khiem_storage/ECCV_results/plainfpn_rectified_1st_trial/model-epoch-00009-iter-24000.ckpt' \
                                                  --log_folder '/mars/mnt/oitstorage/khiem_storage/ECCV_results/sr_fpn_full_1st_trial/' \
