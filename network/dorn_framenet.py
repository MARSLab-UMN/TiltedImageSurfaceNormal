...
class ResNetFrameNet(nn.Module):
    def __init__(self, in_channels=3, pretrained=True, freeze=True):
        super(ResNetFrameNet, self).__init__()
...
class DORNFrameNet(nn.Module):
    def __init__(self, output_size=(240, 320), channel=5, pretrained=True, freeze=True, output_channel=3, dataset='kitti'):
        super(DORNFrameNet, self).__init__()

        self.output_size = output_size
        self.channel = channel
        self.feature_extractor = ResNetFrameNet(in_channels=channel, pretrained=pretrained, freeze=freeze)
