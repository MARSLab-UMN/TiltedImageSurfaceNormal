...
class SpatialRectifierMFPN(nn.Module):
    def __init__(self, fc_img=np.array([0.5 * 577.87061, 0.5 * 580.25851]), canonical_view_cnn_ckpt='', sr_cnn_ckpt=''):
        ...
        # '/mars/mnt/oitstorage/tien_storage/FPN_warping/fpn_rectified_1st_trial/model-epoch-00004-iter-24000.ckpt'))
        # self.canonical_view_cnn.load_state_dict(torch.load('/mars/mnt/dgx/FPN_warping/fpn_robust_acos_scannet_2dof_alignment_2nd_trial/model-epoch-00019-iter-24000.ckpt'))
        # self.canonical_view_cnn.load_state_dict(torch.load('/mars/mnt/dgx/FPN_warping/fpn_rectified_1st_trial/model-epoch-00019-iter-24000.ckpt'))
